...
export async function POST(request) {
  ...
  const { name, email, phone, message, current_page } = data;
  ...
  const html = `
    <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:640px;margin:0 auto;">
      ...
      <p style="font-size:13px;color:#8a8a8a;margin-bottom:20px;">Gobiya.com — Hero form (Submitted from: ${escapeHtml(current_page || 'Unknown page')})</p>
