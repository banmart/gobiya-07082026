...
const TIERS = [
  {
    ...
    features: [
      { label: 'Fix technical problems keeping Google from finding your site', href: '/services/seo' },
      { label: 'Clear, helpful writing for your homepage and service pages', href: '/services/content-marketing' },
      { label: 'Make sure your name, address, and phone number match everywhere online', href: '/services/seo' },
      { label: 'A simple monthly report showing what changed and why', href: '/services/seo' },
    ],
  },
  {
    name: 'Cited',
