        ...
        <div className="container">
          <div className="article__body">
            ...
            <div>
              ...
              <p>We use Google Analytics 4 to understand aggregate site traffic (pages visited, referral sources, approximate location, device type) and Microsoft Clarity to understand how visitors use the site, including session replays, heatmaps, and interaction data. Both services set cookies and collect usage data under their own privacy policies: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a> and <a href="https://privacy.microsoft.com/privacystatement" target="_blank" rel="noopener noreferrer">Microsoft Privacy Statement</a>. The site is hosted on Vercel, which logs standard server request data (IP address, user agent) for security and operations.</p>
            </div>
            <div>
              <h2>Cookies</h2>
              <p>Cookies on this site are used for analytics as described above. You can block or delete cookies in your browser settings; the site works without them. You can also opt out of Google Analytics with the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer">Google Analytics opt-out browser add-on</a>.</p>
            </div>
            <div>
