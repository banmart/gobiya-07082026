 ...
 * bespoke editorial-spread layout with a drop-cap masthead and a
 * contents-in-the-margin aside, matching no other page on the site.
 */
  ...
  return (
    <main id="top" className="svc">
      ...
      <SplitHero
        ...
        primary={{
          text: service.heroCtaText || 'Get a Free Content Check',
          href: service.heroCtaHref || '/free-site-scan?goal=traffic',
        }}
      ...
      {(service.featureRows || []).length > 0 && (
        <HomeBenefitTabs
          ...
          title="What content marketing changes for your business"
          sub="The difference between publishing and actually compounding"
      ...
      <TrackCards
        ...
        dek="The same four steps on every content engagement"
      ...
      <HomeFaq faqs={service.faqs} title="Content marketing questions, answered" />
