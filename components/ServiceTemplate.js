...
export default function ServiceTemplate({ service }) {
  const displayTitle = CLEAN_SERVICE_NAMES[service.slug] || service.eyebrow || (service.title ? service.title.split('|')[0].trim() : 'Service');
    ...
    <main id="top">
      ...
      <section className="mw-subhero">
        <div className="container">
          ...
          <div className="mw-subhero__dek" dangerouslySetInnerHTML={{ __html: service.lede }} />
        </div>
      </section>
