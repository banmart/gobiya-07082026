...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/outcomes/traffic', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/outcomes/rankings', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/outcomes/sales', destination: '/cro-ux-services-los-angeles', permanent: true },
      ...
      { source: '/industries/enterprise-b2b', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/healthcare', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/professional-services', destination: '/seo-services-los-angeles', permanent: true },
      ...
      { source: '/glendale-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/local-seo-glendale', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/glendale', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/glendale-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/glendale-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/seo-company-encino', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/encino', destination: '/seo-services-los-angeles', permanent: true },
      ...
      { source: '/industries/local-service/woodland-hills-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/northridge', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/northridge-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/sherman-oaks', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/sherman-oaks-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/santa-monica', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/santa-monica-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/long-beach-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/long-beach-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/anaheim-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/anaheim-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/local-seo-company-burbank', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/burbank', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/burbank-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/costa-mesa-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/costa-mesa-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/culver-city', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/culver-city-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/north-hollywood', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/north-hollywood-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/silverlake', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/industries/local-service/silverlake-seo', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/locations/van-nuys', destination: '/seo-services-los-angeles', permanent: true },
      ...
      { source: '/on-page-seo-los-angeles', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/los-angeles-seo-services', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/markets/southern-california', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/markets', destination: '/seo-services-los-angeles', permanent: true },
      ...
      { source: '/capabilities/authority-building', destination: '/link-building-services-los-angeles', permanent: true },
      { source: '/capabilities/conversion-architecture', destination: '/cro-ux-services-los-angeles', permanent: true },
      ...
      { source: '/performance/technical-seo-audit-agency', destination: '/seo-services-los-angeles', permanent: true },
      { source: '/relations/authority-building-agency', destination: '/link-building-services-los-angeles', permanent: true },
      { source: '/relations/google-shopping-ads-agency', destination: '/ppc-management-services-los-angeles', permanent: true },
      ...
      { source: '/guides/topic-cluster-architecture', destination: '/content-marketing-services-los-angeles', permanent: true },

      // Old services/* pages with no direct new slug -> closest current service/outcome
      { source: '/services/on-page-seo', destination: '/seo-services-los-angeles', permanent: true },
      ...
      { source: '/services/content-strategy', destination: '/content-marketing-services-los-angeles', permanent: true },
      { source: '/services/digital-pr', destination: '/link-building-services-los-angeles', permanent: true },
      { source: '/services/ai-video-ads', destination: '/ppc-management-services-los-angeles', permanent: true },
