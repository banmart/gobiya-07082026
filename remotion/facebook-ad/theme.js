...
// Matches lib/brand.js + the site's institutional palette. Kept local to this
// composition, same as chatbrat-promo/ and citation-study/.
export const COLORS = {
  navy: '#142f52',
  navyDeep: '#0d2140',
  paper: '#f4f7fb',
