...
//    a verified GSC property. As of 2026-07-27 that's exactly 5 clients:
//    safety-centric.com, smilecenter.com, americanlivescan.com,
//    dgplumbingandrooter.com, and mytrustwills.com. A metric is only shown if
//    it has a genuinely favorable window (7/28/90-day) AND isn't riding on an
//    extremely small base (roughly: single-digit clicks or well under 100
//    impressions) — mytrustwills.com is verified but still fails that bar on
//    every metric, and americanlivescan.com currently has no favorable window
//    at all, so neither shows a GSC card right now. See the per-entry
//    comments below for the current rationale on each.
//
  ...
  cards: [
    {
      ...
      detail: 'Up 96% from 1,618 the quarter before.',
    },
    {
      id: 'clicks',
      label: 'Clicks',
      ...
      display: '52',
      window: 'Last 90 days vs. the 90 before',
      detail: 'Up 8% from 48 the quarter before.',
    },
    {
      id: 'position',
      label: 'Avg. position',
      ...
      detail: 'Improved from 48.1 — lower is better.',
    },
    {
      id: 'ai-grounding',
