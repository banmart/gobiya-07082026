// Client quotes. Verbatim Google reviews — these are published words from real
// reviewers, so they run exactly as written and must not be reworded.
//
// `headline` is the pull-quote the review cards lead with and `role` is the
// attribution line under the name. Entries may also carry `href` to a matching
// /work case study (lib/work.js); all three are optional and the cards render
// without them.
...
export const TESTIMONIALS = [
  {
    ...
    headline: 'You increased my traffic in just 2 days!',
  ...
  },
  {
    ...
    headline: 'All of our marketing goals were met with one source.',
  ...
  {
    name: 'Jeremy Littlefield',
    company: 'Google Review',
    source: 'Google Review',
    role: 'Marketing Director',
    headline: 'Great work and transparent pricing.',
