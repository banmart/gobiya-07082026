...
export const AREAS = [
  ...
  },
  {
    ...
    metaTitle: 'SEO Services Studio City | Studio City Digital Marketing Company',
    metaDescription:
      'Need a dependable Studio City digital marketing company & SEO services? Gobiya SEO delivers proven local search optimization, content strategy, and web development. Call now for a free audit!',
    body: [
      { h2: 'SEO Services & Digital Marketing Company in Studio City' },
      { excerpt: 'Search Optimization & Website Services in the Studio City Area' },
      {
        p: 'Gobiya SEO provides comprehensive SEO services and digital marketing solutions for small and medium-sized businesses across Studio City and the surrounding San Fernando Valley. As a full-service Studio City digital marketing company, our team of search strategists, content creators, and web developers build high-impact campaigns that drive organic traffic, top Google Maps rankings, and qualified leads.',
      },
