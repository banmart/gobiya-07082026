...
export const AREAS = [
  {
    ...
    metaTitle: 'Burbank CA SEO Company | Gobiya SEO',
    metaDescription:
      'Looking for a reliable digital marketing & SEO expert in Burbank CA? Look no further than Gobiya SEO! Our team is dedicated to providing affordable website and SEO services. Call now!',
    body: [
      { h2: 'Burbank Business SEO Services' },
      { excerpt: 'SEO & Website Optimization in the Burbank Area' },
      {
        p: 'Gobiya SEO provides comprehensive search optimization services for businesses throughout the greater Burbank area. Our specialists are seasoned strategists and developers, so every project is executed efficiently and held to the highest standard of quality. Our team is made up of experienced professionals who have spent years building, optimizing, and rescuing websites. We’re proud to be part of this community and to help the businesses around us get found.',
      },
      { cta: true },
  ...
  },
  {
    ...
    metaTitle: 'Glendale CA SEO Company | Gobiya SEO',
    metaDescription:
      'Looking for a reliable Digital marketing & SEO expert in Glendale CA? Look no further than Gobiya SEO! Our team is dedicated to providing affordable website and SEO services. Call now!',
    body: [
      { h2: 'Glendale SEO Agency' },
      { excerpt: 'SEO & Website Optimization in the Los Angeles Area' },
      {
        p: 'Gobiya SEO provides comprehensive search optimization services for small businesses and enterprise brands throughout Glendale and the greater Los Angeles area. Our specialists are seasoned strategists and developers who make sure your project is executed efficiently and held to the highest standard of quality. Our team is made up of skilled professionals who have spent years getting businesses found online. We’re honored to be part of this community and to help our neighbors grow.',
      },
      { cta: { lead: 'Please reach out to us at', style: 'text' } },
      { h3: 'SEO Services We Provide' },
      {
        p: 'Search visibility is a complex system that requires skilled professionals to build, maintain, and repair. At Gobiya SEO, we’re proud to have a team of experienced strategists, writers, and developers capable of handling every part of your online presence.',
      },
      { h4: 'We can help you with:' },
      {
        list: [
      ...
      { h3: 'Why Choose Gobiya SEO?' },
      {
        p: 'Gobiya SEO has established itself as a reliable and trusted search partner in the Los Angeles area, helping Glendale businesses show up on Google and in AI answers alike. With a team of highly skilled and experienced specialists, we’re committed to delivering exceptional results for our clients.',
      },
      {
  ...
  },
  {
    ...
    metaTitle: 'Hollywood CA SEO Company | Gobiya SEO',
    metaDescription:
      'Need a trusted digital marketing & SEO expert in Hollywood CA? Gobiya SEO delivers affordable website builds, technical audits, and content that ranks. Call today!',
    body: [
      { h2: 'Hollywood SEO & Digital Marketing' },
      { excerpt: 'Search Optimization & Website Services in the Hollywood Area' },
      {
        p: 'Gobiya SEO delivers full-service search optimization for creative agencies, studios, retailers, and service businesses across Hollywood and the surrounding neighborhoods. Our specialists are experienced strategists, writers, and developers who treat every project with the same care and technical rigor, whether it’s a five-page site or a thousand-URL migration. Our team has spent years helping businesses climb the results page and stay there. We’re proud to work in a neighborhood where standing out is the whole job.',
      },
      { cta: true },
      { button: { text: 'Get a FREE Site Audit' } },
      { h3: 'SEO Services We Provide' },
      {
        p: 'Search visibility depends on dozens of moving parts working together — site speed, structure, content, authority, and how well machines can read all of it. At Gobiya SEO, we’re proud to field a team equipped to handle every one of those pieces rather than just the easy ones.',
      },
      { h4: 'We can help you with:' },
      {
        list: [
      ...
      { h3: 'Why Choose Gobiya SEO?' },
      {
        p: 'Gobiya SEO has earned a reputation across the Hollywood area as a search partner that shows the work and reports the numbers honestly. Backed by a team of skilled, experienced specialists, we’re focused on results our clients can actually measure — traffic, calls, and revenue, not vanity rankings.',
      },
      {
        p: 'What separates us from the competition is our commitment to doing the work properly the first time. Whether you’re recovering from a sudden traffic drop, need steady content and technical upkeep, or are planning a full rebuild without losing hard-won rankings, Gobiya SEO has you covered. Contact our team today and see our client service and technical depth for yourself.',
      },
      { cta: { phone: '(310) 317-7700' } },
    ],
    image: heroImage(13),
  ...
  },
  {
    ...
    metaTitle: 'Sherman Oaks Website SEO Company | Gobiya SEO',
    metaDescription:
  ...
  },
  {
    ...
    metaDescription:
      'Searching for a dependable digital marketing & SEO expert in Silver Lake CA? Gobiya SEO builds fast websites and content that earns rankings. Call now for a free audit!',
    body: [
  ...
  },
  {
    ...
    metaTitle: 'Studio City CA SEO Company | Gobiya SEO',
    metaDescription:
      'Need a dependable digital marketing & SEO expert in Studio City CA? Gobiya SEO delivers affordable website and SEO services that get results. Call now for a free audit!',
    body: [
      { h2: 'Studio City Web SEO & Digital Marketing' },
      { excerpt: 'Search Optimization & Website Services in the Studio City Area' },
      {
        p: 'Gobiya SEO provides comprehensive SEO optimization for SMBs across Studio City and the surrounding Valley area. Our specialists are experienced strategists, content writers, and web developers who handle every project efficiently and hold it to a highest standard of quality. Our team has spent years helping local businesses show up when customers search. We’re proud to be part of this community and to help our neighbors grow.',
      },
      { cta: { phone: '(310) 317-7700', tail: 'for all your website & SEO needs.' } },
      { button: { text: 'Get a FREE Site Audit' } },
      { h3: 'SEO Services We Provide' },
      {
        p: 'A modern website is a set of connected systems via API/MCP that requires trained professionals to build, optimize, and maintain. At Gobiya SEO, we’re proud to field a team equipped to handle every part of your online presence.',
      },
      { h4: 'We can help you with:' },
      {
        list: [
      ...
      { h3: 'Why Choose Gobiya SEO?' },
      {
        p: 'Gobiya SEO has built a stellar reputation as a reliable, affordable & trusted search partner in the Studio City area. Backed by a team of skilled and experienced specialists, we’re focused on delivering results our clients can measure.',
      },
      {
        p: 'What separates us from the competition is our commitment to quality execution. Whether you need an fast fix after a ranking drop, steady content and technical upkeep, or a full site rebuild and migration, Gobiya SEO has you covered. Contact our team today and see our client service and technical expertise for yourself.',
      },
      { cta: { phone: '(310) 317-7700' } },
    ],
    image: heroImage(17),
