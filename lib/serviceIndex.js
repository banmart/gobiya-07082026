...
const HERO = {
  ...
  'web-ux': {
    image: heroImage(9),
    excerpt: 'Cluttered layouts and slow interactions cause visitors to bounce before taking action. We design intuitive, responsive interfaces that turn clicks into clients.',
...
const EYEBROWS = {
  'seo': 'SEO Services & Search Engine Optimization Agency · Built for Ranking & AI Citations',
