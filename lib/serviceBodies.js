...
export const SERVICE_BODIES = {
  seo: [
    ...
    {
      p: 'Gobiya SEO has built a reputation as a dependable, trusted search partner for Los Angeles businesses that need to be found. The on page SEO services Los Angeles owners get from us cover every page that can bring in a customer, not just the homepage. Backed by a team of highly trained and experienced specialists, we report the numbers that matter to an owner — calls, bookings, and revenue, not vanity rankings.',
    },
    {
