...
export const SERVICE_BODIES = {
  'technical-seo': [
    { h2: 'Los Angeles Technical SEO & On-Page Optimization' },
    { excerpt: 'Turn Search Engine Rankings Into a Predictable Lead Engine for Your Business' },
    {
      p: 'Gobiya SEO provides premier Los Angeles technical SEO services for businesses across Southern California that want to dominate organic search results and convert traffic into sales. We operate as a specialized technical & on-page SEO engineering team, fixing crawl errors, JavaScript rendering issues, internal link distribution, and page architecture from the inside out. For small and medium business owners, our search strategies create a reliable lead pipeline that delivers peace of mind and sustainable ROI. For UI/UX designers, we build site structures that showcase visual excellence without technical bloat slowing down indexation. For in-house marketing managers, we deliver clear organic search metrics and ranking growth that make your monthly reports shine for leadership. We take pride in building long-term search dominance right here in Los Angeles.',
    },
    { cta: true },
    { button: { text: 'Get a FREE Site Audit' } },
    { h3: 'Technical SEO Services We Provide' },
    {
    ...
    {
      p: 'Gobiya SEO has earned a reputation as a trusted search engine optimization partner for Los Angeles companies that demand real business results. Our technical SEO services cover every key landing page that brings in active buyers, not just the homepage.',
    },
    {
...
SERVICE_BODIES.seo = SERVICE_BODIES['technical-seo'];
