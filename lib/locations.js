...
export const LOCATIONS = {
  ...
  'encino-seo': {
    ...
    intro: 'Encino runs along the Ventura Boulevard corridor in the San Fernando Valley, between Tarzana and Sherman Oaks — an affluent, service-business-dense stretch where a <a href="/insights/google-business-profile-seo-checklist">well-optimized Google Business Profile</a> and a fast, mobile-ready site are often the difference between getting the call and losing it to a competitor two listings down.',
  ...
  'sherman-oaks-seo': {
    ...
    intro: 'Sherman Oaks sits between Studio City and Encino along the same Ventura Boulevard corridor, which means service businesses here are often competing for <a href="/insights/google-business-profile-seo-checklist">map pack visibility</a> against neighbors in both adjacent cities, not just within Sherman Oaks itself — a detail that changes how we scope keyword targeting and competitor tracking.',
