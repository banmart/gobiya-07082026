...
export const LOCATIONS = {
  'glendale-seo': {
    ...
    metaDescription:
      'Local SEO for Glendale, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Glendale sits in the Tri-Cities area alongside Burbank and Pasadena, wedged between the 134 and 2 freeways — home to major entertainment and consumer-brand headquarters as well as a dense base of independent local service businesses competing for the same map pack real estate. That competition is exactly why Google Business Profile optimization and citation consistency matter more here than in a less contested market.',
    faq: { q: 'Does Gobiya have an office in Glendale?', a: 'No — Gobiya is headquartered in Los Angeles and works with Glendale-area clients remotely and on-site as needed, the same way we serve the rest of the greater LA metro. We don’t claim a local address we don’t have; we optimize your actual local presence instead.' },
  },
  'encino-seo': {
    slug: 'encino-seo',
    name: 'Encino',
    ...
    metaDescription:
      'Local SEO for Encino, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Encino runs along the Ventura Boulevard corridor in the San Fernando Valley, between Tarzana and Sherman Oaks — an affluent, service-business-dense stretch where a well-optimized Google Business Profile and a fast, mobile-ready site are often the difference between getting the call and losing it to a competitor two listings down.',
  ...
  'studio-city-seo': {
    ...
    region: 'San Fernando Valley',
    metaDescription:
      'Local SEO for Studio City, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Studio City takes its name from the production studios based there, including CBS Studio Center — but the city itself runs on the same independent restaurants, home service providers, and professional practices as any other Ventura Boulevard neighborhood, all competing for local search visibility in a market with real name recognition.',
  ...
  'beverly-hills-seo': {
    ...
    region: 'Westside',
    metaDescription:
      'Local SEO for Beverly Hills, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Beverly Hills is one of the most searched-for city names in Los Angeles service SEO, which cuts both ways — real search volume, but real competition for it too. Between Rodeo Drive retail, Century City-adjacent professional services, and West Hollywood next door, a Beverly Hills-specific local strategy has to differentiate on more than just the city name in a title tag.',
  ...
  'woodland-hills-seo': {
    ...
    metaDescription:
      'Local SEO for Woodland Hills, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Woodland Hills anchors the west end of the San Fernando Valley around the Warner Center business district — a mix of corporate offices and the independent service businesses that support them, from professional services to home and auto repair, all searchable within a fairly tight geographic radius.',
  ...
  'northridge-seo': {
    ...
    region: 'West San Fernando Valley',
    metaDescription:
      'Local SEO for Northridge, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Northridge is anchored by California State University, Northridge, which shapes a distinct local search pattern — a mix of student and faculty households alongside the broader west Valley residential base, all searching for the same category of local service businesses.',
  ...
  'sherman-oaks-seo': {
    ...
    region: 'San Fernando Valley',
    metaDescription:
      'Local SEO for Sherman Oaks, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Sherman Oaks sits between Studio City and Encino along the same Ventura Boulevard corridor, which means service businesses here are often competing for map pack visibility against neighbors in both adjacent cities, not just within Sherman Oaks itself — a detail that changes how we scope keyword targeting and competitor tracking.',
  ...
  'santa-monica-seo': {
    ...
    metaDescription:
      'Local SEO for Santa Monica, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Santa Monica’s tech and startup density — the “Silicon Beach” cluster — sits alongside a coastal tourism economy and a dense residential base, which means local service businesses here are often competing in search against both established local players and better-funded newer entrants at the same time.',
  ...
  'long-beach-seo': {
    ...
    metaDescription:
      'Local SEO for Long Beach, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Long Beach runs its own distinct local economy around the Port of Long Beach and a genuinely separate downtown business district from the rest of Los Angeles County — which means local search here behaves more like an independent mid-size city market than a satellite of central LA.',
  ...
  'anaheim-seo': {
    ...
    metaDescription:
      'Local SEO for Anaheim, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Anaheim’s economy runs heavily on tourism and hospitality around the Disneyland Resort and convention center, but the city’s residential neighborhoods support the same range of home service, professional, and retail businesses as any Orange County city — competing for search visibility in a market where seasonal tourist traffic doesn’t reflect local resident demand.',
  ...
  'burbank-seo': {
    ...
    metaDescription:
      'Local SEO for Burbank, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Burbank is known as a media production hub — Warner Bros., Disney, and Nickelodeon all have studios headquartered there — but the city runs on the same base of independent local service businesses as its Tri-Cities neighbors, competing for map pack visibility in a market with unusually high name recognition for its size.',
  ...
  'costa-mesa-seo': {
    ...
    region: 'Orange County',
    metaDescription:
      'Local SEO for Costa Mesa, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Costa Mesa is home to South Coast Plaza, one of the highest-grossing shopping centers in the country, which anchors a retail- and professional-services-heavy local economy — a market where a strong Google Business Profile and consistent citations matter as much for foot traffic as they do for service calls.',
  ...
  'north-hollywood-seo': {
    ...
    region: 'San Fernando Valley',
    metaDescription:
      'Local SEO for North Hollywood, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'North Hollywood’s NoHo Arts District has reshaped the local business mix over the past two decades, adding a dense cluster of small creative and service businesses to the historically industrial San Fernando Valley base — all of which are now searchable, and competing, in the same local map pack.',
  ...
  'silverlake-seo': {
    ...
    metaDescription:
      'Local SEO for Silver Lake, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Silver Lake’s reputation as a hub for independent, design-forward local businesses means the local search landscape here rewards genuine brand personality and strong reviews more than it does in a more purely transactional suburban market — the competitive bar is set by other well-branded independents, not big-box chains.',
  ...
  'van-nuys-seo': {
    ...
    metaDescription:
      'Local SEO for Van Nuys, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Van Nuys sits at the geographic center of the San Fernando Valley, home to Van Nuys Airport — one of the busiest general aviation airports in the country — and a major civic and government corridor, alongside a dense residential base that drives ordinary local service search demand.',
  ...
  'ventura-seo': {
    ...
    metaDescription:
      'Local SEO for Ventura, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Ventura sits north of the Los Angeles County line in its own county, with a genuinely distinct local economy built around a revitalized downtown and coastal tourism — a market where local search competition looks different from the denser LA County cities, with somewhat less saturation but real seasonal variation.',
  ...
  'santa-clarita-seo': {
    ...
    metaDescription:
      'Local SEO for Santa Clarita, CA service businesses from Gobiya: Google Business Profile optimization, citations, and search visibility that turns nearby searches into booked jobs.',
    intro: 'Santa Clarita is one of the more recently developed cities in Los Angeles County, with a planned-community layout and a mix of established chains and newer independent service businesses — a market where the map pack is less saturated than closer-in LA neighborhoods, but still genuinely competitive for the businesses that are there.',
