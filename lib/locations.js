...
export const LOCATIONS = {
  'glendale-seo': {
    ...
    sections: [
      ...
      {
        heading: 'Also serving other Los Angeles-area service businesses',
        paragraphs: [
          'Glendale is our home base, but the same local SEO playbook runs across the wider region — including <a href="/industries/local-service/encino-seo">Encino</a>, <a href="/industries/local-service/beverly-hills-seo">Beverly Hills</a>, <a href="/industries/local-service/santa-monica-seo">Santa Monica</a>, <a href="/industries/local-service/culver-city-seo">Culver City</a>, <a href="/industries/local-service/north-hollywood-seo">North Hollywood</a>, and <a href="/industries/local-service/ventura-seo">Ventura</a>. See the <a href="/industries/local-service">full list of Los Angeles-area cities</a> we work in.',
        ],
      },
    ],
