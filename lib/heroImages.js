...
export const HERO_VIDEO = '/img/Change_scene_same_background_people_202607291544.webm';
...
// is 9, the cities run 10–19 — so the picture a given page shows stays put
// between builds instead of shuffling whenever the array changes length.
