...
//
// _SM is served under 768px, where the hero is a 16:9 band rather than a
// full-bleed background and phones have the least decode headroom to spare.
export const HERO_VIDEO_MP4 = '/assets/videos/hero-walks-forward-scrub.mp4';
export const HERO_VIDEO_MP4_SM = '/assets/videos/hero-walks-forward-scrub-sm.mp4';
