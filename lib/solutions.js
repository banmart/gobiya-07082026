...
export const SOLUTIONS = {
  'traffic-dropped-rankings-flat': {
    ...
    metaTitle: 'Traffic Dropped, Rankings Flat? Get Them Back | Gobiya',
    metaDescription: 'Traffic dropped or rankings flat after a Google update? Diagnose the indexing blocks, technical errors, and entity gaps holding you back — and recover.',
    eyebrow: 'PROBLEM-SOLVING GUIDE · ALGORITHM RECOVERY & RANKING BOUNCEBACK',
    title: 'Traffic Dropped or Rankings Flat?',
    subtitle: 'When traffic drops and rankings go flat, the cause is diagnosable: indexing blocks, algorithmic penalties, or content decay. Find it, then rebuild authority that commands Google & AI search.',
  ...
  'not-showing-up-in-chatgpt': {
    ...
    metaTitle: 'Not Showing Up in ChatGPT? Become the Answer | Gobiya',
    metaDescription: 'Not showing up in ChatGPT, Perplexity, or Gemini when buyers ask? Here is why your brand is invisible to AI search — and how to earn the citation.',
    eyebrow: 'PROBLEM-SOLVING GUIDE · GENERATIVE ENGINE OPTIMIZATION (GEO)',
    title: 'Not Showing Up in ChatGPT & AI Search?',
    subtitle: 'Not showing up in ChatGPT is fixable: re-engineer your digital footprint so AI assistants extract, quote, and cite your brand when buyers ask for recommendations.',
  ...
  'site-is-slow-losing-leads': {
    ...
    metaTitle: 'Site Is Slow and Losing Leads? Fix Both | Gobiya',
    metaDescription: 'Site slow and losing leads? Fix load times, pass Core Web Vitals, and repair the conversion path so visitors you already have turn into booked work.',
    eyebrow: 'PROBLEM-SOLVING GUIDE · SPEED, UX & CONVERSION RATE OPTIMIZATION',
    title: 'Site is Slow & Losing Leads?',
    subtitle: 'A site that is slow and losing leads has a fixable cause. Eliminate the bloat, pass Core Web Vitals, and streamline conversion paths so every visitor can convert into revenue.',
