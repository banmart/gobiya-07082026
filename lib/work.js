...
export const CASE_STUDIES = [
  ...
  },
  {
    ...
    tag: 'Healthcare & Dental',
    media: { logo: '/assets/img/client-5.webp' },
    ...
    study: {
      ...
      metaDescription:
        'GEO case study: patient-question content architecture and clean schema markup positioned Medicine Metta, an integrative wellness practice, to be cited directly in AI Overviews and ChatGPT answers.',
      answer:
