...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    groups: [
      {
        items: [
          { label: 'Domain Name Lookup', href: '/tools/domain-lookup', built: true },
          { label: 'DNS Lookup', href: '/tools/dns-lookup', built: true },
          { label: 'IP Geolocation', href: '/tools/ip-geolocation', built: true },
          { label: 'Domain Reputation', href: '/tools/domain-reputation', built: true },
          { label: 'Website Categorization', href: '/tools/website-categorization', built: true },
          { label: 'SSL Certificates', href: '/tools/ssl-certificates', built: true },
          { label: 'Threat Intelligence', href: '/tools/threat-intelligence', built: true },
          { label: 'Email Verification', href: '/tools/email-verification', built: true },
        ],
      },
    ],
  },
