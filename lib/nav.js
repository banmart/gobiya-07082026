    ...
    columns: [
      {
        ...
        icon: 'user',
        items: [
          { title: 'Local & Technical SEO', href: '/seo-services', desc: 'Fix backend code errors and rank #1 on Google Maps and organic search.', badge: 'Popular' },
      ...
      },
      {
        ...
        icon: 'clipboard',
        items: [
          { title: 'Content Strategy', href: '/content-marketing-strategies', desc: 'Publish high-intent content built to capture active buyers.' },
          { title: 'Authority Link Building', href: '/link-building-services', desc: 'High-authority editorial mentions and link acquisition.' },
        ],
      },
      {
        ...
        icon: 'briefcase',
        items: [
          { title: 'PPC Management', href: '/ppc-management-services', desc: 'High-ROI Google Ads and conversion funnel management.' },
          { title: 'CRO & Web UX', href: '/conversion-rate-optimization-cro', desc: 'Turn existing site traffic into qualified leads.' },
        ],
      },
    ],
  },
...
export const SECONDARY_NAV = [
  ...
  },
  {
    heading: 'Resources',
    items: [
      { label: 'CRO & UX Analysis', href: '/conversion-rate-optimization-cro' },
      { label: 'AI & LLM Systems Consulting', href: '/ai-consulting-services-los-angeles' },
      { label: 'Digital PR & Link Building', href: '/link-building-services' },
