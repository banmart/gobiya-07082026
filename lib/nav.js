...
export const MEGA_NAV = [
  {
    ...
    columns: [
      {
        heading: 'SEARCH AND AI OPTIMIZATION',
        icon: 'user',
        items: [
          { title: 'SEO', href: '/services/seo', desc: 'Fix backend code errors and rank #1 on Google Maps and organic search.', badge: 'Popular' },
          { title: 'AI Search', href: '/services/geo', desc: 'Get cited and recommended directly by ChatGPT and Perplexity AI.' },
          { title: 'AI Consulting', href: '/services/ai-consulting', desc: 'Put AI to work inside the business, not just in the marketing.' },
        ],
      },
      {
        ...
        icon: 'clipboard',
        items: [
          { title: 'Content', href: '/services/content-marketing', desc: 'Publish high-intent content built to capture active buyers.' },
          { title: 'Link Building', href: '/services/link-building', desc: 'High-authority editorial mentions and link acquisition.' },
      ...
      },
      {
        ...
        icon: 'briefcase',
        items: [
          { title: 'PPC', href: '/services/ppc', desc: 'High-ROI Google Ads and conversion funnel management.' },
          { title: 'CRO', href: '/services/cro', desc: 'Turn existing site traffic into qualified leads.' },
          { title: 'Web UX', href: '/services/web-ux', desc: 'Frictionless interface design and mobile usability.' },
          { title: 'Web Dev', href: '/services/web-dev', desc: 'Sites built with SEO in from day one, not bolted on later.' },
        ],
      },
    ],
  },
