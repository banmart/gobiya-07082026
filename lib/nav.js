    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'Google Ads & PPC', href: '/services/google-ads-ppc', built: true },
      ...
      },
      {
        group: 'Creativity',
        items: [
          { label: 'SEO & Web Copywriting', href: '/services/seo-web-copywriting', built: true },
          { label: 'Content Strategy', href: '/services/content-strategy', built: true },
          { label: 'GEO & AI Content Writing', href: '/services/geo-ai-content-writing', built: true },
          { label: 'AI Video & Ads', href: '/services/ai-video-ads', built: true },
        ],
      },
      {
        group: 'Relations',
        items: [
          { label: 'Authority & Link Building', href: '/services/authority-link-building', built: true },
          { label: 'Digital PR & Media Outreach', href: '/services/digital-pr', built: true },
        ],
      },
    ],
  },
