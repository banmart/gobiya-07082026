    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Conversion Rate Optimization (CRO)', href: '/services/cro', desc: 'Turn existing site traffic into qualified leads.' },
          { title: 'Web UX & User Experience', href: '/services/web-ux', desc: 'Frictionless interface design and mobile usability.' },
