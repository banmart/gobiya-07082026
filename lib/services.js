export const SERVICES = {
  'seo-discoverability': {
    ...
    metaTitle: 'Technical SEO Services: Fix Crawlability & CWV',
    blurb: 'Crawlability, structured data, and Core Web Vitals — the technical foundation search and AI crawlers actually read.',
    metaDescription:
      'Technical SEO services that fix crawlability, indexation, and Core Web Vitals so search and AI crawlers can read your site. Get a free audit.',
    heroLines: ['Technical SEO services,', 'built to be found.'],
    lede: 'Technical SEO services start with one question: can a crawler actually fetch and render your page? If it can’t, no amount of <a href="/services/seo-web-copywriting">content</a> or <a href="/services/authority-link-building">link building</a> will save it. We fix the technical foundation first — rendering, indexation, and structured data — then build the layer that makes the rest of your search strategy actually work. <a href="/onboarding">Request a free technical SEO audit</a> to see what’s capping your traffic.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'What is an organic search strategy?', a: 'An organic search strategy is the plan for earning search traffic without paying for clicks — covering technical SEO, keyword targeting, content structure, and authority building so pages rank for queries that match real buyer intent. Unlike paid search, organic rankings compound over time: a well-optimized page earns traffic long after the initial work is done. Our <a href="/services/seo-discoverability">SEO and discoverability work</a> starts with the technical foundation, then builds the content and authority layer on top. See how this connects to <a href="/outcomes/traffic">long-term organic traffic growth</a>.' },
  ...
  'geo-ai-content-writing': {
    ...
    metaTitle: 'GEO Content Writing Services: Get Cited by AI',
    blurb: 'Content engineered to be quoted verbatim by ChatGPT, Perplexity, and Google AI Overviews.',
    metaDescription:
      'GEO content writing services engineered to get quoted by ChatGPT, Perplexity, and Google AI Overviews. See how AI-ready content earns citations.',
    heroLines: ['GEO content writing,', 'made to be quoted.'],
    lede: 'GEO content writing is built to be extracted, not just read. <a href="/ai-visibility">AI answer engines</a> don’t reward marketing copy — they pull direct, well-structured answers from pages that have already earned their trust. We write content around the exact questions your buyers ask an AI assistant, so your page is the one it quotes. <a href="/onboarding">Start a GEO content audit</a> to see where your current content is losing citations.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      { q: 'Is this just SEO copywriting with a new name?', a: 'It shares the same foundation as our <a href="/services/seo-web-copywriting">SEO copywriting and content strategy</a> work — clear, well-structured, genuinely useful writing — but GEO adds a layer specific to how language models extract information: direct answers near the top, explicit structure, and framing that’s easy to quote verbatim without losing meaning.' },
  ...
  'authority-link-building': {
    ...
    metaTitle: 'Link Building & Digital PR Services That Earn Trust',
    blurb: 'Earned coverage and editorial links that build the trust AI systems check first.',
    metaDescription:
      'Digital PR and link building services from Gobiya: editorial outreach and NAP cleanup that build the domain trust Google and AI systems check first.',
    heroLines: ['Link building services,', 'earned, not bought.'],
    lede: 'Link building services only work when the links are earned. Search engines and AI knowledge graphs use backlinks, citations, and coverage as votes of confidence — and cheap, bulk-purchased links signal the opposite. We earn authority the only durable way: real stories pitched to real publications, manual editorial outreach, and cleanup of the <a href="/industries/local-service">citation inconsistencies</a> that quietly undermine local trust. <a href="/onboarding">Request a backlink and citation audit</a> to see where your profile stands.',
    problem: {
      eyebrow: 'The problem',
    ...
    capabilities: [
      ...
      { tag: 'Relationships', title: 'Journalist relationship building', desc: 'Direct, ongoing relationships with relevant reporters and editors, not one-off blast pitches to a purchased list.' },
    ],
    process: [
  ...
  'web-app-development': {
    ...
    metaTitle: 'Next.js Web Development Services Built to Rank',
    blurb: 'React and Next.js builds with SEO engineered in from the first commit.',
    metaDescription:
      'Next.js and React web development services with SEO and AI visibility engineered in from the first commit, not retrofitted after launch.',
    heroLines: ['Web development services,', 'built to rank.'],
    lede: 'Web development services usually treat SEO as an afterthought — but most sites lose that fight before marketing ever gets involved, in the framework choice, the rendering strategy, the URL structure. We build custom React and Next.js sites and apps with search and <a href="/ai-visibility">AI visibility</a> engineered in from the architecture up, not bolted on after launch. <a href="/onboarding">Talk to us about your build</a> before the tech stack locks in the outcome.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'How is AI used in web development today?', a: 'AI is applied across the development process: AI-assisted coding tools accelerate build speed, AI-driven analytics identify UX friction and performance issues faster than manual audits, and automated schema generation helps ensure structured data is complete from day one. At the architecture level, AI-powered search integrations and chatbot implementations are now standard build considerations rather than afterthoughts. We scope and implement these as part of our development work, and advise on which tools are worth adding versus which add complexity without a return — see our <a href="/services/ai-llm-consulting">AI and LLM systems consulting</a> for the advisory side.' },
    ],
  ...
  'google-ads-ppc': {
    ...
    metaTitle: 'Google Ads Management Services: Lower Cost Per Lead',
    blurb: 'Campaigns rebuilt around cost per lead — with ad creative produced at the speed they burn through it.',
    metaDescription:
      'Google Ads management services rebuilt around cost per lead, not clicks — campaign structure, landing pages, and AI creative. Free ad account audit.',
    heroLines: ['Google Ads management,', 'accountable to leads.'],
    lede: 'Google Ads management services usually optimize for clicks, not booked business. We rebuild campaign structure, negative keyword lists, and landing pages around a single number that matters — <a href="/outcomes/sales">cost per lead</a> that actually converts. Every account we take on gets a full audit before a dollar of spend changes direction. <a href="/onboarding">Request a free Google Ads audit</a> to see where your budget is leaking.',
    problem: {
      eyebrow: 'The problem',
  ...
  'cro-ux': {
    ...
    blurb: 'Find the friction costing you conversions — and fix it with evidence.',
    metaDescription:
      'Conversion rate optimization and UX analysis services that find where visitors drop off and fix the exact friction costing you bookings.',
    heroLines: ['CRO services:', 'more traffic won’t fix a leaky page.'],
    lede: 'Conversion rate optimization services matter most after the traffic problem is already solved — because <a href="/outcomes/rankings">ranking higher</a> and driving <a href="/outcomes/traffic">more traffic</a> doesn’t help if visitors land, hesitate, and leave. We analyze real behavior, identify the specific point of friction, and fix the page — not with a generic best-practices checklist, but with changes tied to how your actual visitors behave. <a href="/onboarding">Get a free CRO review</a> to find out where your site is losing customers.',
    problem: {
      eyebrow: 'The problem',
  ...
  'ai-llm-consulting': {
    ...
    metaTitle: 'AI & LLM Consulting Services for Marketing & Ops',
    blurb: 'Practical AI integration: what is worth building, scoped and implemented.',
    metaDescription:
      'AI and LLM consulting services that separate useful AI tools from hype — search integration, automation, and chatbots scoped to what works.',
    heroLines: ['AI & LLM consulting,', 'applied, not just discussed.'],
    lede: 'AI consulting services matter right now because every vendor is pitching an AI feature, and most of it doesn’t hold up past the demo. We help you separate what’s actually useful — AI-assisted content workflows, <a href="/ai-visibility">search integrations</a>, internal automation — from what’s a distraction, and implement the parts worth building. <a href="/onboarding">Request an AI readiness assessment</a> to find out what’s actually worth your budget.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'What is the best AI SEO software in 2026?', a: 'The answer depends on the problem you are solving. For technical audits and rank tracking, tools like Semrush, Ahrefs, and Screaming Frog remain the benchmarks. For AI-specific visibility monitoring — tracking whether your brand appears in ChatGPT, Perplexity, or Google AI Overviews — the category includes SE Ranking, Profound, and manual prompt sampling. For AI-assisted content research and optimization, quality differences between tools are significant. We cover this in detail in our <a href="/insights/ai-seo-tools-compared">AI SEO tools comparison</a> and advise on tool selection as part of our consulting work.' },
      { q: 'How do AI tools improve digital marketing workflows?', a: 'The highest-value AI applications in digital marketing are in research and analysis: AI tools reduce the time needed to identify keyword clusters, map content gaps, analyze competitor pages, and synthesize search intent across large query sets. Reporting automation is also a consistent win. Where AI tools produce inconsistent results is in execution — content generation without editorial oversight tends to produce generic outputs that underperform human-directed work. The right model is AI as a research and analysis layer, with human judgment on execution. See our <a href="/services/geo-ai-content-writing">GEO and content work</a> for how we apply this in practice.' },
    ],
  ...
  'seo-web-copywriting': {
    ...
    metaTitle: 'SEO Copywriting Services That Rank and Convert',
    blurb: 'Pages written to rank and convert — planned by an editorial strategy built on real demand.',
    metaDescription:
      'SEO copywriting and content strategy services: core site pages written to rank in Google and convert, planned around real search demand.',
    heroLines: ['SEO copywriting services:', 'that rank, and read like a person wrote them.'],
    lede: 'SEO copywriting services often produce pages that read like they were written for an algorithm, planned around habit instead of real demand. We do both jobs as one: an editorial strategy built on what buyers actually search, executed as pages that rank and genuinely read well. <a href="/onboarding">Request a content strategy review</a> to see what your site is missing.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'What is the difference between SEO services and content marketing?', a: 'SEO services cover the full system: technical foundation, site authority, content strategy, and on-page optimization — everything that determines whether a page ranks. Content marketing is the editorial and production side: writing, publishing, and distributing content. In practice, content marketing without SEO produces pieces that are well-written but rarely found; SEO without content produces a technically clean site with nothing worth ranking. We run both as a single system — the editorial strategy is built from real search demand, and every piece is written to both rank and convert. See how <a href="/services/seo-discoverability">technical SEO</a> and <a href="/services/geo-ai-content-writing">AI content writing</a> connect to the copywriting work.' },
