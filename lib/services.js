export const SERVICES = {
  'seo-discoverability': {
    ...
    lede: 'If a crawler can’t fetch and render your page, no amount of content or link building will save it. We fix the technical foundation first, then build the indexation and structured-data layer that makes the rest of your search strategy actually work.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'Do we need to rebuild our whole site to fix this?', a: 'Usually not. Most technical SEO problems are fixable without a rebuild — rendering configuration, schema injection, and crawl-path fixes can typically be layered onto an existing codebase. A full rebuild is only the right call when the underlying platform genuinely can’t support server-side rendering.' },
    ],
  ...
  'geo-ai-content-writing': {
    ...
    lede: 'AI answer engines don’t reward marketing copy — they extract and quote direct, well-structured answers. We write content around the exact questions your buyers ask an AI assistant, so your page is the one it pulls from.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      { q: 'Is this just SEO copywriting with a new name?', a: 'It shares the same foundation — clear, well-structured, genuinely useful writing — but GEO adds a layer specific to how language models extract information: direct answers near the top, explicit structure, and framing that’s easy to quote verbatim without losing meaning.' },
      ...
      { q: 'How do you measure whether this is working?', a: 'We track two things: traditional rankings and impressions, and direct citation appearances — running your target prompts against ChatGPT, Perplexity, and Google AI Overviews on a regular cadence to see whether your pages are actually being cited.' },
    ],
  ...
  'authority-link-building': {
    ...
    lede: 'Search engines and AI knowledge graphs use backlinks and citations as votes of confidence. We run manual, editorial outreach to real publications — not automated link packages — and clean up the citation inconsistencies that quietly undermine local trust.',
    problem: {
      eyebrow: 'The problem',
  ...
  'web-app-development': {
    ...
    lede: 'Most sites lose their SEO fight before marketing ever gets involved — the framework choice, the rendering strategy, the URL structure. We build custom React and Next.js sites and apps with search and AI visibility engineered in from the architecture up.',
    problem: {
      eyebrow: 'The problem',
  ...
  'google-ads-ppc': {
    ...
    lede: 'Most Google Ads accounts are optimized for clicks, not booked business. We rebuild campaign structure, negative keyword lists, and landing pages around a single number that matters — cost per lead that actually converts.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'Do you handle both the ads and the landing pages?', a: 'Yes — that alignment is usually where the biggest gains come from. A well-run campaign sending traffic to a generic homepage still underperforms; matching the landing page to the ad’s specific promise is often the single highest-leverage fix.' },
    ],
  ...
  'cro-ux': {
    ...
    lede: 'Ranking higher and driving more traffic doesn’t matter if visitors land, hesitate, and leave. We analyze behavior, identify the specific point of friction, and fix the page — not with a generic best-practices checklist, but with changes tied to how your actual visitors behave.',
    problem: {
      eyebrow: 'The problem',
  ...
  'ai-llm-consulting': {
    ...
    lede: 'Every vendor is pitching an AI feature right now, and most of it doesn’t hold up past the demo. We help you separate what’s actually useful — AI-assisted content workflows, search integrations, internal automation — from what’s a distraction, and implement the parts that are worth it.',
    problem: {
      eyebrow: 'The problem',
    ...
    faqs: [
      ...
      { q: 'Is this the same as your GEO and AI content work?', a: 'They’re related but distinct. GEO content writing is about getting your existing pages cited by AI answer engines. This is broader — evaluating and implementing AI tools and systems across marketing and operations, which may or may not involve content at all.' },
  ...
  'seo-web-copywriting': {
    ...
    lede: 'Most SEO copy reads like it was written for an algorithm, and most great copy ignores search intent entirely. We write core site and service pages that do both — structured to rank, and genuinely worth reading once someone lands.',
    problem: {
      eyebrow: 'The problem',
  ...
  'content-strategy': {
    ...
    faqs: [
      ...
      { q: 'Do you write the content, or just plan it?', a: 'Both, typically in coordination with our SEO & web copywriting and GEO content services — the strategy determines what to write and why, and we can execute the writing directly or hand the plan to your existing team.' },
  ...
  'ai-video-ads': {
    ...
    capabilities: [
      ...
      { tag: 'Integration', title: 'Paid media integration', desc: 'Creative built in coordination with actual campaign targeting and budget, not produced in isolation from the media plan.' },
    ],
    process: [
  ...
  'digital-pr': {
    ...
    lede: 'Digital PR is link building’s more visible cousin — real coverage, in real publications, from a pitch a journalist actually wanted to run. We build the story and the relationships, and the authority signal follows naturally.',
    problem: {
      eyebrow: 'The problem',
