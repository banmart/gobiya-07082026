export const SERVICES = {
  'seo-discoverability': {
    ...
    metaDescription:
      'SEO services and organic search strategy from Gobiya: technical SEO, crawlability, structured data, and Core Web Vitals — the search engine marketing foundation that makes organic traffic grow.',
  ...
  'geo-ai-content-writing': {
    ...
    metaDescription:
      'AI content writing and content optimization from Gobiya: AI marketing tools and GEO strategies that engineer your content to be cited by ChatGPT, Perplexity, and Google AI Overviews.',
  ...
  'web-app-development': {
    ...
    metaDescription:
      'Web and app development with AI from Gobiya: custom React and Next.js builds with AI in the development workflow, server-rendered and SEO-native from the first commit, not retrofitted after launch.',
  ...
  'ai-llm-consulting': {
    ...
    metaDescription:
      'AI marketing tools and LLM systems consulting from Gobiya: practical guidance on AI SEO software, AI search integration, chatbots, and automation for your marketing and operations stack.',
  ...
  'seo-web-copywriting': {
    ...
    metaDescription:
      'SEO copywriting and content optimization from Gobiya: core site pages written to rank in Google and convert, planned around real search demand, website optimization best practices, and AI citation potential.',
