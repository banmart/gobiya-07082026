export const SERVICES = {
  ...
  'cro-ux': {
    ...
    lede: 'Conversion rate optimization services matter most after the traffic problem is already solved — because <a href="/seo-services">ranking higher</a> and driving <a href="/seo-services">more traffic</a> doesn’t help if visitors land, hesitate, and leave. We analyze real behavior, identify the specific point of friction, and fix the page — not with a generic best-practices checklist, but with changes tied to how your actual visitors behave. <a href="/onboarding">Get a free CRO review</a> to find out where your site is losing customers.',
    problem: {
      eyebrow: 'The problem',
  ...
  'ai-llm-consulting': {
    ...
    faqs: [
      ...
      { q: 'Is this the same as your GEO and AI content work?', a: 'They’re related but distinct. <a href="/geo-services">GEO content writing</a> is about getting your existing pages cited by AI answer engines. This is broader — evaluating and implementing AI tools and systems across marketing and operations, which may or may not involve content at all.' },
