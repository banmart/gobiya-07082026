export const SERVICES = {
  ...
  'authority-link-building': {
    ...
    blurb: 'Editorial links and clean citations that build the trust AI systems check first.',
    metaDescription:
  ...
  'google-ads-ppc': {
    ...
    blurb: 'Campaigns rebuilt around cost per lead, not clicks.',
    metaDescription:
  ...
  'seo-web-copywriting': {
    ...
    blurb: 'Pages written to rank in Google and convert once they do.',
    metaDescription:
  ...
  'content-strategy': {
    ...
    blurb: 'Editorial plans built on real demand, not a publishing habit.',
    metaDescription:
  ...
  'ai-video-ads': {
    ...
    pillar: 'Creativity',
    title: 'AI Video & Ads',
    blurb: 'Fast-iteration ad creative without the production shoot.',
    metaDescription:
  ...
  'digital-pr': {
    ...
    blurb: 'Earned coverage that produces links a journalist chose to place.',
    metaDescription:
